...
def get_rating_html(rating):
    ...
    content = f"<img src=\"/images/wT9F00t1BuDE9wRx/sf.png\">" * fullstars
    content += "<img src=\"/images/wT9F00t1BuDE9wRx/sh.png\">" * hashalf
    content += "<img src=\"/images/wT9F00t1BuDE9wRx/se.png\">" * empties
...
def get_listing_html(game):
    ...
    if game.dlc or game.hundo or game.plat:
        ...
        if game.plat:
            icons += "<img alt=\"plat\" src=\"/images/wT9F00t1BuDE9wRx/plat.png\">"
        icons += "</span>"
...
def get_icon_css(iconid):
    ...
    x = -64 * int(iconid[4:6])
    y = -64 * int(iconid[2:4])
    return f"img#i{iconid}{{background:url(/images/wT9F00t1BuDE9wRx/{filename}) {x}px {y}px}}"
...
<link href="/stylesheets/game-records-icons.css" rel="stylesheet" type="text/css">
