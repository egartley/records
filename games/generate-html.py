...
signaturehtml += "<script src=\"/resources/js/game-records.js\" type=\"application/javascript\"></script>\n"
signaturehtml += "<div class=\"modal\"><div class=\"modal-content card\"><p id=\"modal-text\"></p></div></div>\n"
